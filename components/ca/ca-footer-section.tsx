...
export function CaFooterSection() {
  return (
    <footer
    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-16 pt-12 lg:pt-20 pb-0">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-x-6 gap-y-10 md:gap-12 lg:gap-8 pb-12 lg:pb-16">
          ...
          <div className="col-span-2">
            <img src="/reakon no-bg logo-black.png" alt="Reakon" style={{ height: "48px", display: "block", marginBottom: "22px" }} />
            <p className="leading-relaxed mb-6 max-w-xs text-base" style={{ color: "rgba(0,0,0,0.55)" }}>
              Your clients&apos; GST, done before you open Excel. Free for your firm.
            </p>

            {/* Toggle back to owner view */}
            <div className="mb-8">
              <AudienceToggle active="cas" size="sm" />
            </div>
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title}>
              <h3 className="text-xs font-mono uppercase tracking-widest mb-5" style={{ color: "rgba(0,0,0,0.4)" }}>{title}</h3>
      ...
      {/* Giant wordmark */}
      <div className="relative w-full flex justify-center select-none pointer-events-none mt-9 lg:mt-[60px]" style={{ overflow: "hidden" }}>
        <img
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-16" style={{ marginTop: "16px" }}>
        <div className="pt-5 pb-5 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left" style={{ borderTop: "1px solid rgba(0,0,0,0.1)" }}>
