...
export function CaFinalCtaSection() {
      ...
      <div className="max-w-[1400px] mx-auto px-5 sm:px-6 lg:px-12">
        ...
        >
          <div
            ...
            style={{ background: `radial-gradient(600px circle at ${mousePosition.x}% ${mousePosition.y}%, rgba(0,0,0,0.15), transparent 40%)` }}
          />
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
              <div className="flex-1 w-full">
                <h2 className="text-[clamp(2rem,8vw,2.75rem)] lg:text-7xl font-display tracking-tight mb-6 lg:mb-8 leading-[1.05] lg:leading-[0.95]">
                  Do less manual work.<br />
                  Start with one client.
                </h2>

                <p className="text-lg sm:text-xl text-muted-foreground mb-8 lg:mb-12 leading-relaxed max-w-xl">
                  Join the Reakon CA Partnership Program. Bring one client on, see what we recover, and decide from there.
                </p>
                ...
                <p className="text-sm text-muted-foreground mt-8 font-mono">
                  No cost to your firm · Works with your existing workflow · Data stored in India
                </p>
              </div>
            </div>
          </div>
